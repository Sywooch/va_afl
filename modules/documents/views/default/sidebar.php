...
<div class="col-lg-3 panel">
    <div class="panel-body">
        ...
        <div class="hline"></div>
        <p><a href="/documents"> <?= Yii::t('app', 'All') ?></a> <span
                class="badge badge-theme pull-right"><?= count($all) ?></span></p>
        <?php foreach ($categories as $cat): ?>

            <p><a href="/documents/<?= $cat->link ?>"> <?= $cat->name ?></a> <span
        ...
        <ul class="popular-posts list-unstyled">
            <?php foreach (Content::documents(5) as $post): ?>
                <li class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <p><a target="_blank"
                                                     href="/documents/<?= $post->categoryInfo->link ?>/<?= $post->link ?>"><?= $post->description ?></a>
                            </p>
                        </div>
                        <div class="col-md-12">
