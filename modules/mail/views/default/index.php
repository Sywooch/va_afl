...
<ul class="list-group list-group-lg no-radius list-email">
    <li class="list-group-item inverse">
        ...
        <div class="email-info">
            ...
            <p class="email-desc">
                Praesent id pulvinar orci. Donec ac metus non ligula faucibus venenatis. Suspendisse tortor est,
                placerat eu dui sed...
            </p>
        </div>
    </li>
    <li class="list-group-item primary">
        ...
        <div class="email-info">
            ...
            <p class="email-desc">Proin interdum aliquam urna, quis lobortis magna tincidunt ac. Integer sed pulvinar
                neque...
            </p>
        </div>
    </li>
    ...
    <li class="list-group-item inverse">
        ...
        <div class="email-info">
            ...
            <p class="email-desc">
                Proin consectetur accumsan rhoncus. Nulla porta orci ultricies lectus consequat fringilla. Vestibulum
    ...
    <li class="list-group-item inverse">
        ...
        <div class="email-info">
            ...
            <p class="email-desc">
                Suspendisse ut urna orci. Vivamus ac diam sollicitudin, consequat mauris id, facilisis ipsum. Nam
                feugiat nisl a justo...
            </p>
        </div>
    </li>
    ...
    <li class="list-group-item danger">
        ...
        <div class="email-info">
            ...
            <p class="email-desc">
                Maecenas auctor dui sit amet tristique congue. Pellentesque lobortis nulla quam. Etiam in vulputate
                magna...
            </p>
        </div>
    </li>
