...
==============================
- Создаём или берём issue
- Делаем pull из master
- Выполняем разработку в ветке, имя которой отражает название issue
- После окончания разработки делаем Merge Request
